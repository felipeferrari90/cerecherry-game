...
//DEFINA O TAMANHO DA FASE E O NUMERO DE TILES HORIZONTAIS E VERTICAIS no construtor Fase
    ...
    const faseTemplate = new Fase(7,10); //new Fase(TilesHorizontais,TilesVerticais)

    //DEFINA O NUMERO DA SUA FASE: (number)
    faseTemplate.faseNumber = 2

    //DEFINA O NOME DA SUA FASE: (string)
    faseTemplate.faseName = "Caminho da morte";

    //ADICIONE DESCRITIVOS DA SUA FASE (string - pode ter varios argumentos)
    faseTemplate.comments = [
        "TESTE COMENTARIO 1",
        "TESTE COMENTARIO 2",
        "TESTE COMENTARIO LONGO 3 aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
    ]
...
//DEFINA COORDENADAS DE PONTOS DE INICIO na string (separe por virgula para mais de um valor)
    ...
    faseTemplate.tilesStart.push("10-7-baixo","2-7-direita", "7-1-esquerda","3-1-cima",) 
